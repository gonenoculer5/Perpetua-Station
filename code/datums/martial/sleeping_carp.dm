...
/datum/martial_art/the_sleeping_carp/teach(mob/living/carbon/human/H, make_temporary = FALSE)
	...
	ADD_TRAIT(H, TRAIT_STUNRESISTANCE, SLEEPING_CARP_TRAIT) //READDED BY XEON, AS ARE BELOW RESISTANCES
...
/datum/martial_art/the_sleeping_carp/on_remove(mob/living/carbon/human/H)
	...
	REMOVE_TRAIT(H, TRAIT_STUNRESISTANCE, SLEEPING_CARP_TRAIT) //READDED BY XEON
