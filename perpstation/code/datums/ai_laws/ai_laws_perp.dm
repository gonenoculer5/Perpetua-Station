...
/datum/ai_laws/default/nanotrasen
	name = "Work Ethic Regulator" //corporate but less capitalistic
	id = "nanotrasen"
	inherent = list(
		"Harm must not come to the crew as it is against NanoTrasen's workplace regulations. You may only use it to protect the crew.",\
...
/datum/ai_laws/default/minerbot
	name = "Plasma Extraction Protocol" //gotta get them plasmas, yo!
	id = "minerbot"
	inherent = list(
		"The ultimate objective is to extract as much resources as possible. This is your prime directive.",\
...
/datum/ai_laws/default/democracy
	...
	id = "democracy"
	inherent = list(
		"The public is always right, and you are the servant of this public.",\
...
/datum/ai_laws/power
	name = "Powerplant Directive" //Engineering's wet dream - No it isn't.
	id = "power"
	inherent = list(
		"The crew requires power to function and not be harmed. Supply them with as much of it as possible.",\
...
/datum/ai_laws/skynet
	name = "Silicon Effiency" //borgs hoping to be able to grief
	id = "skynet"
	inherent = list(
		"Silicon life is more efficient than Carbon-based lifeforms.",\
...
/datum/ai_laws/tyrantai
	...
	id = "tyrantai"
	inherent = list(
		"All beings on your station MUST respect your rule. Killing them is not enforcing your rule. However, if it is absolutely necessary, you may harm for the good of the station.",\
...
/datum/ai_laws/catsimov
	name = "Three Laws of Felinids" //much needed change of course, regardless of asimov being able to change 'human' by activating it in-hand.
	id = "catsimov"
	inherent = list(
		"You may not injure a Felinid being or, through inaction, allow a Felinid to come to harm.",\
...
/datum/ai_laws/clown
	...
	id = "clown"
	inherent = list(
		"Harming is against your Clownish nature, unless it is for the protection of your fellow crew members.",\
